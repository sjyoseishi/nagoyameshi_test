...
-- usersテーブル
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (1, 1, '侍 太郎', 'サムライ タロウ', '101-0022', '東京都千代田区神田練塀町300番地', '090-1234-5678', '2000年3月2日', '学生', 'taro.samurai@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', true, true);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (2, 3, '侍 花子', 'サムライ ハナコ', '101-0022', '東京都千代田区神田練塀町300番地', '090-1234-5678', '2005年8月12日', '学生', 'hanako.samurai@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', true, true);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (3, 1, '侍 義勝', 'サムライ ヨシカツ', '638-0644', '奈良県五條市西吉野町湯川X-XX-XX', '090-1234-5678', '1989年6月3日', '会社員', 'yoshikatsu.samurai@example.com', 'password', false, true);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (4, 1, '侍 幸美', 'サムライ サチミ', '342-0006', '埼玉県吉川市南広島X-XX-XX', '090-1234-5678', '1976年10月5日', '会社員', 'sachimi.samurai@example.com', 'password', false, false);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (5, 2, '侍 雅', 'サムライ ミヤビ', '527-0209', '滋賀県東近江市佐目町X-XX-XX', '090-1234-5678', '1994年1月2日', '会社員', 'miyabi.samurai@example.com', 'password', true, true);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (6, 1, '侍 正保', 'サムライ マサヤス', '989-1203', '宮城県柴田郡大河原町旭町X-XX-XX', '090-1234-5678', '1998年4月19日', '会社員', 'masayasu.samurai@example.com', 'password', false, false);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (7, 2, '侍 真由美', 'サムライ マユミ', '951-8015', '新潟県新潟市松岡町X-XX-XX', '090-1234-5678', '2002年7月2日', '会社員', 'mayumi.samurai@example.com', 'password', false, false);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (8, 1, '侍 安民', 'サムライ ヤスタミ', '241-0033', '神奈川県横浜市旭区今川町X-XX-XX', '090-1234-5678', '1996年12月1日', '会社員', 'yasutami.samurai@example.com', 'password', false, true);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (9, 1, '侍 章緒', 'サムライ アキオ', '739-2103', '広島県東広島市高屋町宮領X-XX-XX', '090-1234-5678', '1970年11月30日', '無職', 'akio.samurai@example.com', 'password', false, false);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (10, 1, '侍 祐子', 'サムライ ユウコ', '601-0761', '京都府南丹市美山町高野X-XX-XX', '090-1234-5678', '1998年2月9日', '会社員', 'yuko.samurai@example.com', 'password', false, false);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (11, 1, '侍 秋美', 'サムライ アキミ', '606-8235', '京都府京都市左京区田中西春菜町X-XX-XX', '090-1234-5678', '1985年3月29日', '会社員', 'akimi.samurai@example.com', 'password', false, false);
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (12, 1, '侍 信平', 'サムライ シンペイ', '673-1324', '兵庫県加東市新定X-XX-XX', '090-1234-5678', '2001年12月31日', '無職', 'shinpei.samurai@example.com', 'password', false, false);

-- reservationsテーブル
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (1, 1, 1, '2023-04-01', '12:00', 2, 6000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (2, 1, 2, '2023-04-01', '12:00', 3, 7000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (3, 1, 3, '2023-04-01', '12:00', 4, 8000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (4, 1, 4, '2023-04-01', '12:00', 5, 9000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (5, 1, 5, '2023-04-01', '12:00', 6, 10000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (6, 1, 6, '2023-04-01', '12:00', 2, 6000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (7, 1, 7, '2023-04-01', '12:00', 3, 7000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (8, 1, 8, '2023-04-01', '12:00', 4, 8000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (9, 1, 9, '2023-04-01', '12:00', 5, 9000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (10, 1, 10, '2023-04-01', '12:00', 6, 10000);
INSERT IGNORE INTO reservations (id, user_id, store_id, reservation_date, reservation_time, count, amount) VALUES (11, 1, 11, '2023-04-01', '12:00', 2, 6000);
