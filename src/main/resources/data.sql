...
INSERT IGNORE INTO users (id, role_id, name, furigana, postal_code, address, phone_number, age, occupation, email, password, enabled, paid_member) VALUES (5, 2, '侍 雅', 'サムライ ミヤビ', '527-0209', '滋賀県東近江市佐目町X-XX-XX', '090-1234-5678', '1994年1月2日', '会社員', 'miyabi.samurai@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', true, true);
